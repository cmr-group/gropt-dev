...
def sample_between(
    ...
    high : float
        Upper bound of the uniform distribution (inclusive for practical use,
        generated by ``numpy.random.Generator.uniform``).
    rng : np.random.Generator
        Random number generator instance to use. Pass a seeded generator for
        reproducible results across calls.
    decimals : int | None, optional
        Number of decimal places to round to. If ``None``, no rounding is
        applied.
