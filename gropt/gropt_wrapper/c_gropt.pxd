...
cdef extern from "gropt_params.hpp" namespace "Gropt":
    ...
    cdef cppclass SolveResult:
        SolveResult() except +
        # VectorXd X  -- accessed via solver
        bint converged
        int n_iter
        int n_feval
...
cdef extern from "solver_groptsdmm.hpp" namespace "Gropt":
    cdef cppclass SolverGroptSDMM:
        ...
        SolveResult solve(GroptParams &gparams)
        ...
        bint last_result_converged "last_result.converged"
        int last_result_n_iter "last_result.n_iter"
        int last_result_n_feval "last_result.n_feval"
