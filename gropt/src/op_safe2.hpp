...
class Op_SAFE2 : public Operator
{  
    protected:
        double stim_thresh;
    ...
    public:
        SAFE2Params safe_params;

        Op_SAFE2(GroptParams &_gparams, double _stim_thresh, double _weight_mod);
        Op_SAFE2(GroptParams &_gparams, int _N_vec, double *_stim_thresh_vec, double _weight_mod);
        virtual void init();
